...
type
  /// <summary>Classe que representa um produto. Mapeia diretamente as colunas da tabela PRODUTO no banco de dados. </summary>
  TProduto = class
  private
    FCodigo: Integer;
    FDescricao: string;
  ...
  public
    /// <summary>Cria uma nova instância da classe TProduto com valores padrão. </summary>
    constructor Create; overload;

    /// <summary>Cria uma nova instância da classe TProduto com valores definidos.</summary>
    ...
    /// <summary>Destrói a instância da classe TProduto. </summary>
    ...
    /// <summary>Obtém e define o NCM do produto. </summary>
