...
type
  /// <summary>
  /// Classe para encapsular a lógica de conexão com o banco de dados Firebird.
  /// </summary>
  TConexaoBanco = class
  private
  ...
  public
    ...
    /// <summary>
    /// Cria uma nova instância da classe TConexaoBanco.
    /// </summary>
    constructor Create; overload;

    /// <summary>
    /// Cria e configura uma nova instância da classe TConexaoBanco.
    /// </summary>
    constructor Create(pEnderecoIP, pNomeBancoDados, pUsuarioBanco, pSenhaBanco,
       pTipoBaseDados: string); overload;

    /// <summary>
    /// Destrói a instância da classe TConexaoBanco.
    /// </summary>
    ...
    /// <summary>
    /// Obtém o objeto de conexão TFDConnection.
    /// </summary>
